...
import fr.avion.ecrandejeu.GameScreen;
import fr.avion.ecrandejeu.Player;
import fr.avion.gerer.EnemyBulletHandler;
import fr.avion.phantasm.SpriteAnimation;
import fr.avion.son.Sound;
import fr.avion.temps.Timer;
import fr.avion.tiredenemy.EnemyBasicBullet;
...
public class EnemyTypeBasic extends EnemyType{
	...
	public boolean isOutOfBounds() {
		if(rect.x > 0 && rect.x < Affichage.WIDTH - rect.width)
			return false;
		return true;
	}
